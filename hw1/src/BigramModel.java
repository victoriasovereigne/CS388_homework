...
public class BigramModel {
	...
	public void printList(List<String> sentence)
	{
	...
	public void printMap(Map<String, DoubleValue> map){
	...
	public static void main(String[] args) throws IOException {
		System.out.println("BigramModel");
		...
		// model.trainSentences(trainSentences);
		// System.out.println("-----------UNIGRAM-----------");
		// model.printMap(model.unigramMap);
		// System.out.println("-----------BIGRAM-----------");
		// model.printMap(model.bigramMap);

		// System.out.println("----------------------");
		
		// model.calculateProbs();
		...
		// SortedSet<String> keys = new TreeSet<String>(model.bigramMap.keySet());
		// for (String key : keys)
		// {
